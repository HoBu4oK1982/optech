@section('title', 'Редактирование спецпредложения — OPTECH')
@section('page-title', 'Редактирование спецпредложения')
<div>
    <div class="ad-page-head"><div><h2>Обновление спецпредложения</h2></div><a wire:navigate href="{{ route('offers') }}" class="ad-btn"><i class="fas fa-arrow-left"></i> Все спецпредложения</a></div>
    <div class="ad-panel-shell">
        ...
        <div class="ad-form-grid" style="margin-top:14px;">
            ...
            <div class="ad-field"><span>Изображение</span>
                <div style="display:flex;gap:14px;align-items:center;flex-wrap:wrap;">
                    ...
                    @if($image)@php($oimg = file_exists(public_path('assets/images/offers/'.$image)) ? asset('assets/images/offers/'.$image) : asset('assets/images/offers/'.$image))<img src="{{ $oimg }}" class="ad-thumb" style="width:120px;height:auto;object-fit:contain;background:#fff;" onerror="this.style.display='none'">@endif
                </div>
            </div>
            ...
            <div class="ad-field">
                ...
                <div class="ad-upload">
                    <input type="file" class="ad-upload__input" id="offer-edit-og" wire:model="og_image" accept="image/*">
                    @if($og_image)
                    ...
                    @endif
                    <label for="offer-edit-og" class="ad-upload__zone">
        ...
        <div style="margin-top:20px;"><button class="ad-btn ad-btn-primary" wire:click="updateOffer"><i class="fas fa-save"></i> Обновить</button></div>
    </div>
</div>
