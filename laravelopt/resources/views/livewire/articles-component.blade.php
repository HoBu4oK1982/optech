    ...
    <div class="ad-panel-shell">
        ...
        <div class="ad-table-wrap">
            <table class="ad-table">
                <thead><tr><th style="width:64px;">Фото</th><th>Заголовок</th><th>Дата</th><th>Статус</th><th style="text-align:right;">Действия</th></tr></thead>
                <tbody>
                ...
                @empty
                    <tr><td colspan="5"><div class="ad-empty"><i class="fas fa-newspaper"></i>Статей пока нет.</div></td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
