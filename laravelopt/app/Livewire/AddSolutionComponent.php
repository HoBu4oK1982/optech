...
class AddSolutionComponent extends Component
{
    ...
    protected $rules = [
        ...
        'slug' => 'required|unique:solutions,slug',
    ...
    public function addSolution()
    {
        ...
        $s->save();
        session()->flash('success', 'Решение создано.');
        return redirect()->route('solutions');
    }

    protected function fill_($s)
    {
    ...
    {
        return view('livewire.add-solution-component', [
