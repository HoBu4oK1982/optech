...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('categories', function (Blueprint $table) {
            // --- Per-language meta (RU уже есть как meta_title/description/keywords) ---
            ...
            // --- H1 (отдельно от названия), по языкам ---
            ...
            // --- SEO-тексты над и под листингом (ключевой фактор ранжирования категорий в RU/KZ) ---
            ...
            // --- UX / навигация ---
            $table->string('breadcrumb_title')->nullable()->after('is_indexable');
            $table->string('icon')->nullable()->after('breadcrumb_title');
            $table->integer('sort_order')->default(0)->after('icon');

            // --- FAQ-блок -> FAQ schema на странице категории ---
